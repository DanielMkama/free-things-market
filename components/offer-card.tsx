  ...
  return (
    ...
    >
      <div className="mb-8 flex items-start justify-between gap-4">
        ...
        <span className="text-right text-xs font-semibold uppercase tracking-widest text-muted">
          {locationLabel(offer)}
        </span>
      </div>

      <h3 className="font-display text-2xl uppercase leading-[0.95] tracking-tight md:text-[1.7rem]">
        {offer.title}
      </h3>
  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        <span className="text-xl">{CATEGORY_EMOJI[request.category] ?? "✨"}</span>
        <span className="text-xs font-bold uppercase tracking-widest text-muted">
          {request.type}
        </span>
      </div>
      <div>
        <h3 className="font-display text-2xl uppercase leading-[0.95] tracking-tight md:text-3xl">
          {request.title}
        </h3>
      ...
      <div className="flex items-start justify-between gap-2 text-xs font-semibold uppercase tracking-widest text-muted md:flex-col md:items-end md:text-right">
